...
complete -c harbor -n __harbor_no_subcommand -a u -d 'Start service(s)'
complete -c harbor -n __harbor_no_subcommand -a start -d 'Start service(s)'
complete -c harbor -n __harbor_no_subcommand -a s -d 'Start service(s)'
complete -c harbor -n __harbor_no_subcommand -a down -d 'Stop and remove containers'
complete -c harbor -n __harbor_no_subcommand -a d -d 'Stop and remove containers'
complete -c harbor -n __harbor_no_subcommand -a restart -d 'Down then up'
complete -c harbor -n __harbor_no_subcommand -a r -d 'Down then up'
...
complete -c harbor -n __harbor_no_subcommand -a log -d 'View container logs'
complete -c harbor -n __harbor_no_subcommand -a l -d 'View container logs'
...
complete -c harbor -n __harbor_no_subcommand -a aliases -d 'Manage aliases'
complete -c harbor -n __harbor_no_subcommand -a a -d 'Manage aliases'
...
complete -c harbor -n __harbor_no_subcommand -a profiles -d 'Manage profiles'
complete -c harbor -n __harbor_no_subcommand -a p -d 'Manage profiles'
complete -c harbor -n __harbor_no_subcommand -a gum -d 'Run gum CLI'
complete -c harbor -n __harbor_no_subcommand -a fixfs -d 'Fix file ownership for service volumes and caches'
...
complete -c harbor -n __harbor_no_subcommand -a h -d 'Command history'
...
complete -c harbor -n __harbor_no_subcommand -a t -d 'Start tunnel'
...
complete -c harbor -n __harbor_no_subcommand -a dmr -d 'Configure Docker Model Runner'
complete -c harbor -n __harbor_no_subcommand -a mlx -d 'Configure MLX'
complete -c harbor -n __harbor_no_subcommand -a omlx -d 'Configure oMLX'
...
complete -c harbor -n __harbor_no_subcommand -a opencode -d 'Run opencode'
...
complete -c harbor -n __harbor_no_subcommand -a plandex -d 'Launch Plandex'
complete -c harbor -n __harbor_no_subcommand -a pdx -d 'Launch Plandex'
complete -c harbor -n __harbor_no_subcommand -a mistralrs -d 'Configure mistral.rs'
complete -c harbor -n __harbor_no_subcommand -a interpreter -d 'Launch Open Interpreter'
complete -c harbor -n __harbor_no_subcommand -a opint -d 'Launch Open Interpreter'
complete -c harbor -n __harbor_no_subcommand -a cfd -d 'Run cloudflared'
complete -c harbor -n __harbor_no_subcommand -a cloudflared -d 'Run cloudflared'
complete -c harbor -n __harbor_no_subcommand -a cmdh -d 'Run cmdh'
complete -c harbor -n __harbor_no_subcommand -a fabric -d 'Run Fabric'
complete -c harbor -n __harbor_no_subcommand -a parler -d 'Configure Parler'
complete -c harbor -n __harbor_no_subcommand -a photoprism -d 'Configure PhotoPrism'
complete -c harbor -n __harbor_no_subcommand -a airllm -d 'Configure AirLLM'
complete -c harbor -n __harbor_no_subcommand -a txtai -d 'Configure txtai'
complete -c harbor -n __harbor_no_subcommand -a aider -d 'Launch Aider'
complete -c harbor -n __harbor_no_subcommand -a nanobot -d 'Run nanobot'
complete -c harbor -n __harbor_no_subcommand -a chatui -d 'Configure ChatUI'
complete -c harbor -n __harbor_no_subcommand -a comfyui -d 'Configure ComfyUI'
complete -c harbor -n __harbor_no_subcommand -a aichat -d 'Run aichat'
complete -c harbor -n __harbor_no_subcommand -a omnichain -d 'Omnichain service'
complete -c harbor -n __harbor_no_subcommand -a lmeval -d 'LM Evaluation Harness'
complete -c harbor -n __harbor_no_subcommand -a lm_eval -d 'LM Evaluation Harness'
complete -c harbor -n __harbor_no_subcommand -a sglang -d 'Configure SGLang'
complete -c harbor -n __harbor_no_subcommand -a jupyter -d 'Configure Jupyter'
complete -c harbor -n __harbor_no_subcommand -a ol1 -d 'Configure ol1'
complete -c harbor -n __harbor_no_subcommand -a ktransformers -d 'Configure ktransformers'
complete -c harbor -n __harbor_no_subcommand -a openhands -d 'Run OpenHands'
complete -c harbor -n __harbor_no_subcommand -a oh -d 'Run OpenHands'
complete -c harbor -n __harbor_no_subcommand -a stt -d 'Configure STT'
complete -c harbor -n __harbor_no_subcommand -a speaches -d 'Configure Speaches'
complete -c harbor -n __harbor_no_subcommand -a boost -d 'Configure Boost'
complete -c harbor -n __harbor_no_subcommand -a nexa -d 'Run Nexa'
complete -c harbor -n __harbor_no_subcommand -a repopack -d 'Run Repopack'
complete -c harbor -n __harbor_no_subcommand -a k6 -d 'Run k6'
complete -c harbor -n __harbor_no_subcommand -a promptfoo -d 'Run promptfoo'
complete -c harbor -n __harbor_no_subcommand -a pf -d 'Run promptfoo'
complete -c harbor -n __harbor_no_subcommand -a webtop -d 'Configure Webtop'
complete -c harbor -n __harbor_no_subcommand -a langflow -d 'Configure Langflow'
complete -c harbor -n __harbor_no_subcommand -a kobold -d 'Configure Koboldcpp'
complete -c harbor -n __harbor_no_subcommand -a morphic -d 'Configure Morphic'
complete -c harbor -n __harbor_no_subcommand -a gptme -d 'Run gptme'
complete -c harbor -n __harbor_no_subcommand -a hermes -d 'Configure Hermes'
complete -c harbor -n __harbor_no_subcommand -a mcp -d 'Configure MCP'
complete -c harbor -n __harbor_no_subcommand -a modularmax -d 'Configure Modular MAX'
complete -c harbor -n __harbor_no_subcommand -a openfang -d 'Configure OpenFang'
