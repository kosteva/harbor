...
export const serviceMetadata: Record<string, Partial<HarborService>> = {
    ...
    tei: {
        ...
        tags: [HST.backend, HST.api],
        projectUrl: 'https://github.com/huggingface/text-embeddings-inference',
        logo: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
        wikiUrl: `${wikiUrl}/2.2.26-Backend-Text-Embeddings-Inference`,
        tooltip: 'High-performance embedding, reranking and sequence classification server from Hugging Face.',
    },
    lightrag: {
        name: 'LightRAG',
    ...
    linkwarden: {
        name: 'Linkwarden',
        tags: [HST.satellite],
        projectUrl: 'https://github.com/linkwarden/linkwarden',
        logo: 'https://www.google.com/s2/favicons?domain=linkwarden.app&sz=128',
        wikiUrl: `${wikiUrl}/2.3.97-Satellite-Linkwarden`,
        tooltip: 'Self-hosted collaborative bookmark manager with archiving and AI-powered tagging.',
    },
    whishper: {
        name: 'Whishper',
        tags: [HST.satellite, HST.audio],
        projectUrl: 'https://github.com/pluja/whishper',
        logo: 'https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/whishper.png',
        wikiUrl: `${wikiUrl}/2.3.96-Satellite-Whishper`,
        tooltip: 'Self-hosted audio transcription and subtitle editor powered by Whisper, with LibreTranslate translation.',
    },
    paperless: {
        name: 'Paperless-ngx',
        tags: [HST.satellite, HST.tools],
        ...
        tooltip: 'Document management system that scans, indexes and archives your documents with OCR.',
    },
    'paperless-gpt': {
        name: 'Paperless-GPT',
        tags: [HST.satellite, HST.tools],
