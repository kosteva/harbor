...
Set `BASIC_AUTH_USER`/`BASIC_AUTH_PASS`, required before exposing Marinara beyond loopback/Docker traffic. With no arguments, prints the configured user (never the password).
